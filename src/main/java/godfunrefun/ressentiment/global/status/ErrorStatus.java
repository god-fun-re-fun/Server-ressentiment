package godfunrefun.ressentiment.global.status;

import godfunrefun.ressentiment.global.code.BaseErrorCode;
...
//    ADDRESS_IO_EXCEPTION(HttpStatus.INTERNAL_SERVER_ERROR, "ADDRESS_001", "입출력 처리 중 오류가 발생했습니다."),
    ...
    DATE_NOT_FOUND(HttpStatus.NOT_FOUND,"SCHEDULE_004","해당 날짜의 형태가 올바르지 않습니다."),
